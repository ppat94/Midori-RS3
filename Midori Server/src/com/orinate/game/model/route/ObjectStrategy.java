...
public class ObjectStrategy extends RouteStrategy {
	...
	public ObjectStrategy(WorldObject object) {
		...
		this.sizeX = rotation == 0 || rotation == 2 ? ObjectDefinition.forId(object.getId()).sizeX : ObjectDefinition.forId(object.getId()).sizeY;
		this.sizeY = rotation == 0 || rotation == 2 ? ObjectDefinition.forId(object.getId()).sizeY : ObjectDefinition.forId(object.getId()).sizeX;
		this.accessBlockFlag = ObjectDefinition.forId(object.getId()).walkToData;
		if (rotation != 0)
