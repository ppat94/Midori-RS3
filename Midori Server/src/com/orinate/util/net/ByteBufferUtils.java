...
import com.orinate.util.stream.BufferInputStream;
import com.orinate.util.stream.BufferOutputStream;
...
public final class ByteBufferUtils {
	 ...
	 * @return The value.
	 */
	public static int getSmart0(ByteBuffer buffer) {
		int value = 0;
	...
	public static void putObject(ByteBuffer buffer, Object o) {
		ByteBuffer b;
		try (ObjectOutputStream out = new ObjectOutputStream(new BufferOutputStream(b = ByteBuffer.allocate(100000)))) {
			out.writeObject(o);
			b.flip();
		} catch (Throwable e) {
			e.printStackTrace();
